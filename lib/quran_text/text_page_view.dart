...
class TextPageView extends StatefulWidget {
  ...
  TextPageView({this.nomPageF, this.nomPageL, this.pageNum = 0, this.surah});
...
class _TextPageViewState extends State<TextPageView>
  ...
  QuranTextCubit TextCubit = QuranTextCubit();
...
bool visible=false;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<QuranTextCubit, QuranTextState>(
      ...
      builder: (BuildContext context, state) {
        TextCubit = QuranTextCubit.get(context);
                  ...
                  children: [
                    SizedBox(
                      ...
                      child:
                          ...
                          //     children: getSurahPages(orientation),
                          //   )
                          PageView.builder(
                        // shrinkWrap: true,
                                                                  ...
                                                                  if (TextCubit
                                                                    ...
                                                                    TPageScaffoldKey.currentState?.showBottomSheet(
                                                                        ...
                                                                        (context) => Align(
                                                                              ...
                                                                              child: Padding(
                                                                                padding: orientation == Orientation.portrait ? const EdgeInsets.symmetric(horizontal: 0.0) : const EdgeInsets.symmetric(horizontal: 64.0),
                                                                                child: Container(
                                                                                  height: orientation == Orientation.portrait ? MediaQuery.of(context).size.height * 1 / 2 : MediaQuery.of(context).size.height,
                                ...
                                text.add(
                                  TextSpan(children: [
                                    TextSpan(
                                      ...
                                      style: TextStyle(
                                          fontSize:
                                              TextPageView.fontSizeArabic + 10,
  ...
  List<Widget> getSurahPages(Orientation orientation) {
    List<Widget> ist = [];
    for (var index = 0;
        index < (widget.nomPageL! - widget.nomPageF!) + 1;
        index++) {
      List<InlineSpan> text = [];
      int ayahLenght = widget.surah!.ayahs!.length;
      for (int b = 0; b < ayahLenght; b++) {
              ...
              TextSpan(
                  ...
                  recognizer: TapGestureRecognizer()
                    ..onTapDown = (TapDownDetails details) {
                      setState(() {
                        backColor = Colors.transparent;
                        TextCubit.sorahName = widget.surah!.number!.toString();
                        TextCubit.ayahNum =
                              ...
                              children: [
                                Container(
                                  ...
                                  child: FutureBuilder<List<Ayat>>(
                                      future: QuranTextCubit.get(context)
                                          .handleRadioValueChanged(
                      ...
                      print('${widget.surah!.name!}');
                      print('${widget.surah!.number!}');
                      print('${widget.surah!.ayahs![b].numberInSurah}');
                      print('${widget.nomPageF}');
                      print('${widget.nomPageL}');
                    })
            ]));
                        ...
                        child: SelectableText.rich(
                          ...
                          TextSpan(
                            style: TextStyle(
                                fontSize: TextPageView.fontSizeArabic,
                                backgroundColor:
                                    TextCubit.bColor ?? Colors.transparent,
                                fontFamily: 'uthmanic2'),
                            children: text.map((e) {
                              return e;
                            }).toList(),
